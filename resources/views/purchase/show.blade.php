                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ $data->no_po }}</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    <div class="col-4">
                        ...
                        @if ($data->status == 'draft')
                            <a href="{{ route('purchase.edit', [$data->id]) }}" class="btn btn-info btn-sm">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-9">
                                                <div>Prefix</div>
                                                <span class="title-text">{{ $data->no_po }}</span>
                                            </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-6">
                                                <dl class="row">
                                                    <dt class="col-3"><strong>Sales Order</strong></dt>
                                                    <dd class="col-9">{{ $data->sales->no_so }}</dd>
        ...
        document.querySelectorAll('.statusButton').forEach(item => {
            item.addEventListener('click', event => {
                ...
                Swal.fire({
                    ...
                    text: "Apakah anda yakin ingin melakukan approve untuk purchase order ini?!",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "{{ url('purchase/approve') }}/" + poId;
                    }
                });
            });
        });
