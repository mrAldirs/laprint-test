                ...
                <tbody>
                    @foreach ($data as $contact)
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{ route('supplier.show', [$contact->id]) }}" class="btn btn-secondary btn-sm">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <a href="{{ route('supplier.edit', [$contact->id]) }}" class="btn btn-info btn-sm">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <form action="{{ route('supplier.destroy', [$contact->id]) }}" method="post"
